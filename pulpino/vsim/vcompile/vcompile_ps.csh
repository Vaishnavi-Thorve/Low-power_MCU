...
source ${PULP_PATH}/vsim/vcompile/library.csh  || exit 1
...
vlog -quiet -sv -work "work" +incdir+${TB_PATH} +incdir+${RTL_PATH}/includes/                  ${TB_PATH}/tb.sv            || goto error
...
vlog -quiet -sv -work "work" +incdir+${TB_PATH} +incdir+${RTL_PATH}/includes/ -dpiheader ${TB_PATH}/mem_dpi/dpiheader.h    ${TB_PATH}/tb.sv || goto error

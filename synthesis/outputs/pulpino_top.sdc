...
#  Created by Genus(TM) Synthesis Solution 16.12-s027_1 on Tue May 14 12:51:09 +0200 2024
...
create_clock -name "clk" -period 40.0 -waveform {0.0 20.0} 
set_clock_transition -max 0.2 [get_clocks clk]
create_clock -name "spi_clk_i" -period 76.924 -waveform {0.0 38.462} 
set_clock_transition -max 0.2 [get_clocks spi_clk_i]
create_clock -name "tck_i" -period 76.924 -waveform {0.0 38.462} 
set_clock_transition -max 0.2 [get_clocks tck_i]
set_clock_groups -asynchronous -group [get_clocks clk] -group [get_clocks spi_clk_i] -group [get_clocks tck_i]
set_clock_gating_check -setup 0.0 
set_input_delay -clock [get_clocks tck_i] -add_delay 0.5 [get_ports tdi_i]
set_input_delay -clock [get_clocks tck_i] -add_delay 0.5 [get_ports tms_i]
set_input_delay -clock [get_clocks tck_i] -add_delay 0.5 [get_ports trstn_i]
set_input_delay -clock [get_clocks tck_i] -add_delay 0.5 [get_ports tck_i]
set_input_delay -clock [get_clocks tck_i] -add_delay 0.5 [get_ports uart_dsr]
set_input_delay -clock [get_clocks tck_i] -add_delay 0.5 [get_ports uart_cts]
set_input_delay -clock [get_clocks tck_i] -add_delay 0.5 [get_ports uart_rx]
set_input_delay -clock [get_clocks tck_i] -add_delay 0.5 [get_ports spi_sdi3_i]
set_input_delay -clock [get_clocks tck_i] -add_delay 0.5 [get_ports spi_sdi2_i]
set_input_delay -clock [get_clocks tck_i] -add_delay 0.5 [get_ports spi_sdi1_i]
set_input_delay -clock [get_clocks tck_i] -add_delay 0.5 [get_ports spi_sdi0_i]
set_input_delay -clock [get_clocks tck_i] -add_delay 0.5 [get_ports spi_cs_i]
set_input_delay -clock [get_clocks tck_i] -add_delay 0.5 [get_ports spi_clk_i]
set_input_delay -clock [get_clocks tck_i] -add_delay 0.5 [get_ports fetch_enable_i]
set_input_delay -clock [get_clocks tck_i] -add_delay 0.5 [get_ports testmode_i]
set_input_delay -clock [get_clocks tck_i] -add_delay 0.5 [get_ports rst_n]
set_input_delay -clock [get_clocks tck_i] -add_delay 0.5 [get_ports clk]
set_output_delay -clock [get_clocks tck_i] -add_delay 0.5 [get_ports tdo_o]
set_output_delay -clock [get_clocks tck_i] -add_delay 0.5 [get_ports gpio_out]
set_output_delay -clock [get_clocks tck_i] -add_delay 0.5 [get_ports uart_dtr]
set_output_delay -clock [get_clocks tck_i] -add_delay 0.5 [get_ports uart_rts]
set_output_delay -clock [get_clocks tck_i] -add_delay 0.5 [get_ports uart_tx]
set_output_delay -clock [get_clocks tck_i] -add_delay 0.5 [get_ports spi_sdo3_o]
set_output_delay -clock [get_clocks tck_i] -add_delay 0.5 [get_ports spi_sdo2_o]
set_output_delay -clock [get_clocks tck_i] -add_delay 0.5 [get_ports spi_sdo1_o]
set_output_delay -clock [get_clocks tck_i] -add_delay 0.5 [get_ports spi_sdo0_o]
set_output_delay -clock [get_clocks tck_i] -add_delay 0.5 [get_ports {spi_mode_o[0]}]
set_output_delay -clock [get_clocks tck_i] -add_delay 0.5 [get_ports {spi_mode_o[1]}]
...
set_clock_latency -max 0.5 [get_ports spi_clk_i]
set_clock_latency -source -max 0.5 [get_ports spi_clk_i]
set_clock_uncertainty -setup 0.5 [get_ports spi_clk_i]
set_clock_uncertainty -hold 0.5 [get_ports spi_clk_i]
set_clock_latency -max 0.5 [get_ports tck_i]
set_clock_latency -source -max 0.5 [get_ports tck_i]
set_clock_uncertainty -setup 0.5 [get_ports tck_i]
set_clock_uncertainty -hold 0.5 [get_ports tck_i]
